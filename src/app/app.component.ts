import { Component, Inject, OnDestroy, OnInit, ElementRef, Renderer2, isDevMode} from '@angular/core';
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.core$ = this.configService.getAppConfigObservable().subscribe(config =>{
      ...
      this.title.setTitle(this.coreTranslationService.translateText('3Days'));
    });
