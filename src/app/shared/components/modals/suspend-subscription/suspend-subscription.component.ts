...
export class SuspendSubscriptionComponent {
  ...
  suspendSubscription():void{
    ...
    console.log('subscription info', this.param);
    this.httpService.post('suspend-subscription', {
      subscription_id: this.param.subscription_id, 
      suspension_days: this.param.suspension_days,  
      suspension_date: this.param.suspension_date}).then((response: any)=>{
